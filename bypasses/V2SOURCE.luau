...
BYPASS_SUBVERSION = "FullEmulated"
...
HandshakeEmulated = LPH_NO_VIRTUALIZE(function(...)
	...
	elseif Args[1] == false then
		...
		game:GetService("Players").LocalPlayer
			:Kick("SASGUARD EMULATOR ERROR: UNEXPECTED HANDSHAKE RESPONSE" .. tostring(Args[1]))
		return
	end
end)
...
if getreg and hookfunction and isexecutorclosure and getgc then
	...
	BYPASS_SUBVERSION = "OnlyEmulated"
	if getnilinstances then
		BYPASS_SUBVERSION = "AltEmulated"
